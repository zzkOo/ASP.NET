<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="medInControl.ascx.cs" Inherits="HospitalManagement.WebUI.Controls.medInControl" %>
<div class="cenGV">
    <div class="form-group">
        <label for="medName" class="col-sm-4 control-label text-right">请输入退还的药品名称：</label>
        <div class="col-sm-8">
            <asp:TextBox ID="medName" runat="server" class="form-control" placeholder="Medicine Name"></asp:TextBox>
        </div>
    </div>
    <div class="form-group">
        <label for="medCount" class="col-sm-4 control-label text-right">请输入退还的药品数量：</label>
        <div class="col-sm-8">
    ...
    <div style="width: 800px; margin: 0 auto;text-align: center;">
        <asp:GridView ID="gvAdd" runat="server" Width="800px" Font-Size="Medium">
